    ...
    \begin{figure}
      ...
      \subbottom[Pre-bleach]{%
        ...
        \begin{tikzpicture}[inner sep=0pt]
          ...
          \draw[red] (1.75,0.50) circle (5pt);
          \draw[red] (1.05,-0.70) circle (5pt);
          \draw[red] (-0.05,-1.10) circle (5pt);
          \draw[red] (-0.70,-2.10) circle (5pt);
          \draw[red] (-1.40,0.30) circle (5pt);
          \draw[red] (-2.35,1.75) circle (5pt);
        \end{tikzpicture}%
      }
      ...
      \subbottom[\SI{52}{\min}]{% (3156.7-36.715) / 60
        ...
        \begin{tikzpicture}[inner sep=0pt]
          ...
          \draw[->,red,thick] (1.4,1.2) -- (1.8, 1.2);
          \draw[->,red,thick] (0.3,-0.4) -- (0.7, -0.4);
          \draw[->,red,thick] (-0.9,0.5) -- (-0.5, 0.5);
          \draw[->,red,thick] (-1.9,0.6) -- (-1.5, 0.6);
          \draw[->,red,thick] (-2.6,2.0) -- (-2.2, 2.0);
          \draw[->,red,thick] (-1.2,-1.8) -- (-0.8, -1.8);
        \end{tikzpicture}%
      }
      ...
      \subbottom[\SI{127}{\min}]{% (7656.7-36.715)/60
        \label{fig:kill-frap:first-frap:127-min}%
        \begin{tikzpicture}[inner sep=0pt]
          \node at (0,0) {\includegraphics[width=0.45\linewidth]%
      ...
      \captionIntro{Circle FRAP of H2B--EGFP in HeLa}%
        {
          ...
          --\subcaptionref{fig:kill-frap:first-frap:127-min}
