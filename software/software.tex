...
Even if the original data is available and the infrastructure environment under
which the computational analysis was done is available, reproducing results
...
assembly but the process of maintaining software has many parallels with
...
system \citep{scons}.  SCons was designed to be a
...
SCons although it is very commonly used in bioinformatics.
To enable the use of SCons for our project we created
