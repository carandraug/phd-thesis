...
releases was implemented with extra capabilities that were not needed
for the project.
They could have also even been implemented
directly in the BioPerl PluginBundle.  However, having
them as separate plugin components enables other software projects to use
them.

As free software, there is no sales or reliable download data
...
reuse by other software developers.
...
included Bio-EUtilities with it.
