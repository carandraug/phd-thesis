...
\section{DNA methods}
  ...
  \subsection{Polimerase Chain Reaction}
    ...
    temperature of the annealing step, and time of extension step were different. Values on \tref{tab:pcr-settings}
    ...
    \todo[inline]{what's the PCR model we have in the lab?}
    ...
    \subsubsection{Mutagenesis}
      ...
      in\todo{in or from?} other plasmids. After amplification, \SI{1.5}{\ul} of restriction enzyme DpnI\footnote{Because
      ...
      overnight at \dc{37}. \SI{1}{\ul} was used for transformation and individual clones screened by sequencing.
      
      \todo[inline]{where should we mention care on primer design? Picking the codon with optimal usage for mutagenesis.
                    Here or in the FRAP chapter?}

    \subsubsection{Screening}
    
    \begin{sidewaystable}
      %% FIXME use the eqparbox package to have the columns match??
      \centering
      \captionIntro{PCR mixtures and conditions used.}{}
      \label{tab:pcr-settings}
      \begin{tabular}{l c c c c c}
        \toprule
        \null                                 & \begin{tabular}{@{}c@{}}amplification \\ (genomic)\end{tabular} &
                                                \begin{tabular}{@{}c@{}}amplification \\ (plasmid)\end{tabular} &
                                                colony & mutagenesis & screening \\
        \midrule
        Template (\si{\ng})                   & 1000      & 50        & n/a        & 750       &            \\
        DMSO (\si{\ul})                       & 2         &           & 1          &           &            \\
        Buffer ($\times$)                     & 1         & 1         & 1          & 1         & 1          \\
        MgSO$_4$ (\si{\nmol})                 & 1.5       & 1.5       &            & 1.5       &            \\
        dNTPs (\si{\mM} each)                 & 0.2       & 0.2       & 0.2        & 0.2       &            \\
        Primer (forward) (\si{\micro\Molar})  & 2         & 2         & 2          & 0.4       &            \\
        Primer (reverse) (\si{\micro\Molar})  & 2         & 2         & 2          & 0.4       &            \\
        DNA polymerase (\si{U})               & 0.5 (KOD) & 0.5 (KOD) & 0.05 (Taq) & 0.5 (KOD) & 0.05 (Taq) \\
        \addlinespace
        Total volume (\si{\ul})               & 25        & 25        & 25         & 25        & 25         \\
      \end{tabular}
      \newcolumntype{W}{r<{\si{\second}}}
      \newcolumntype{T}{l<{\si{\degreeCelsius}}}

      \begin{tabular}{l W@{ at }T W@{ at }T W@{ at }T W@{ at }T}
        \midrule
        Initialization                & 120 & 94    & 120 & 94    & 180 & 94    & 120 & 94    & 120 & 94 \\
        Denaturation                  &  30 & 94    &  30 & 94    &  15 & 94    &  30 & 94    &  15 & 94 \\
        Annealing                     &  20 & 58    &  20 & 94    &  15 & 58    &  20 & 58    &  15 & 62 \\
        Extension (per \si{\kilo\bp}) &  30 & 68    &  20 & 72    &  60 & 72    &  30 & 68    &  45 & 72 \\
        Final extension               & 300 & 62    & 300 & 72    & 300 & 72    & 300 & 94    & 300 & 72 \\
        Final hold                    & \multicolumn{2}{c}{\dc{4}} & \multicolumn{2}{c}{\dc{4}} &
                                        \multicolumn{2}{c}{\dc{4}} & \multicolumn{2}{c}{\dc{4}} &
                                        \multicolumn{2}{c}{\dc{4}} \\
        Number of cycles              & \multicolumn{2}{c}{30$\times$} & \multicolumn{2}{c}{30$\times$} &
                                        \multicolumn{2}{c}{30$\times$} & \multicolumn{2}{c}{15$\times$} &
                                        \multicolumn{2}{c}{20$\times$} \\
        \bottomrule
      \end{tabular}
    \end{sidewaystable}
