  ...
  \subsection{Polimerase Chain Reaction}
    ...
    \begin{sidewaystable}
      ...
      \begin{tabular}{l W@{ at }T W@{ at }T W@{ at }T W@{ at }T W@{ at }T}
        \toprule
        \null                                 & \multicolumn{4}{c}{amplification} & \crows{colony} & \crows{mutagenesis} & \crows{screening} \\
                                                       \cmidrule(r){2-5}
        \null                                 & \crows{genomic} & \crows{plasmid} \\
        \midrule
        Template (\si{\ng})                   & \crows{1000}      & \crows{50}        & \crows{n/a}        & \crows{750}       & \crows{ }          \\
        DMSO (\si{\ul})                       & \crows{2}         & \crows{ }         & \crows{1}          & \crows{ }         & \crows{ }          \\
        Buffer ($\times$)                     & \crows{1}         & \crows{1}         & \crows{1}          & \crows{1}         & \crows{1}          \\
        MgSO$_4$ (\si{\nmol})                 & \crows{1.5}       & \crows{1.5}       & \crows{ }          & \crows{1.5}       & \crows{ }          \\
        dNTPs (\si{\mM} each)                 & \crows{0.2}       & \crows{0.2}       & \crows{0.2}        & \crows{0.2}       & \crows{ }          \\
        Primer (forward) (\si{\micro\Molar})  & \crows{2}         & \crows{2}         & \crows{2}          & \crows{0.4}       & \crows{ }          \\
        Primer (reverse) (\si{\micro\Molar})  & \crows{2}         & \crows{2}         & \crows{2}          & \crows{0.4}       & \crows{ }          \\
        DNA polymerase (\si{U})               & \crows{0.5 (KOD)} & \crows{0.5 (KOD)} & \crows{0.05 (Taq)} & \crows{0.5 (KOD)} & \crows{0.05 (Taq)} \\
        \addlinespace
        ...
        Number of cycles              & \crows{30$\times$} & \crows{30$\times$} & \crows{30$\times$} & \crows{30$\times$} & \crows{30$\times$} \\
        \bottomrule
      \end{tabular}
    \end{sidewaystable}
