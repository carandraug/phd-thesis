...
according to \Aref{app:solutions} with Milli-Q purified water, and autoclaved prior to use when appropriate.
...
\section{Software used}
  ...
  %% We probably should use a script to get the actual version when building
  %% the thesis. On the other hand, this thesis will not be a liquid document,
  %% since unfortunately it is only meant for evaluation of my doctoral
  ...
  respectively.
  %% This is not an error! Both optim and signal packages are version 1.3.0
