...
\chapter{Solutions}
  ...
  %% It will NOT work with memoir's ctabular. Use longtable from the longtable package
  %% if the table becomes too long and needs to span multiple pages
  ...
  \begin{tabular}{>{\bfseries}N p{\dimexpr(\textwidth-\eqboxwidth{firstentry}-4\tabcolsep)}}
    \toprule
    Name & Recipe\\
    \midrule
