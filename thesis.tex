...
\begin{document}
  ...
  \include{./histone-catalogue/histone-catalogue}
  \include{./kill-frap/kill-frap}
  \include{./fancy-frap/fancy-frap}
  ...
  \bibliography{intro/references,methods/references,kill-frap/references,h2ax-review/H2AXreview-biblio}
