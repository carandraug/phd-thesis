...
\section{Chromatin}
  ...
  \subsection{Nucleosome structure}
    ...
    \begin{figure}
      \centering
      \subbottom[]{%
        %% a) rat thymus positive staining, b) rat thymus negative staining,
        %% c) chicken erythrocyte positive staining.
        %% Maybe we should include only one of this pictures.
        \includegraphics[width=\textwidth]%
        {"intro/figures/beads-on-a-string"}
      ...
      \captionIntro{Schematic of nucleosome in chromatin fibers.}%
                   {\subcaptionref{fig:intro:beads-on-a-string} Rat thymus
                    and chicken erythrocyte chromatin fibers
                    spilling out of ruptured nuclei depicting the
    ...
    \subsubsection{Histone Fold Domain}
      ...
      \begin{figure}
        ...
        \subbottom[]{%
          ...
          {"intro/results/nucleosome-h2a"}
          \includegraphics[width=0.32\textwidth]%
          {"intro/results/nucleosome-h2b"}
          \includegraphics[width=0.32\textwidth]%
          {"intro/results/nucleosome-h2a-h2b-dimer"}
