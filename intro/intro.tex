\section{Chromatin}
  ...
  \subsection{Histones}
    ...
    to form the core particle \frefp{fig:intro:nucleosome-side-view}.
    ...
    \subsubsection{Histone variants}
      ...
      Each of the histones protein types is encoded by a family
      ...
      \afterpage{%
        ...
        \begin{shaded}%
          ...
          \item[\cite{richmond-1kx5-19ansgtrom}]
            ...
            \SI{1.9}{\angstrom} resolution of \SI{1.9}{\angstrom}, the
