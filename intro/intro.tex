...
\section{Bioinformatics}
  ...
  are searched in online databases rather than
  ...
  This has been attributed in part to the fact that bioinformaticians
  mainly fill a role of support which adds to the challenge of career
  progression in academia \citep{wren2016bioinformatics}.
  ...
  The absence of the code in publications not only delays research by
  ...
  try and replicate a single figure or table, with some figures taking more
  ...
  The results did not imply that results have been fabricated.
  While the main problem identified was the unavailability
  of the data, the second was the lack of detail on how to perform the
  analysis.
  ...
  There is a growing
  interest within the scientific community to change the current state
  ...
  Despite the lack of computational details for the data analysis,
