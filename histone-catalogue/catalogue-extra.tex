...
\newpage
\begin{center}
  \captionof{figure}[Mice H2A CDS alignment]{
    Sequence logo for the mice canonical H2A gene coding regions
    listed in table \tref{tab:mice:histone-catalogue}.
...
\newpage
\begin{center}
  \captionof{figure}[Mice H2B CDS alignment]{
...
\newpage
\begin{center}
  \captionof{figure}[Mice H3 CDS alignment]{
...
\newpage
\begin{center}
  \captionof{figure}[Mice H4 CDS alignment]{
...
\begin{figure}[h!]
  ...
  \subtop[Stem-loop]{
    ...
    \label{fig:mice:stem-loop-seqlogo}
  }
  \hfill
  \subtop[HDE]{
    \includegraphics{\FigsDir/seqlogo_HDEs.pdf}
    \label{fig:mice:HDE-seqlogo}
  }
  \caption[Stem-loop and HDE alignment]{%
    Sequence logos for
    \subcaptionref{fig:mice:stem-loop-seqlogo} annotated stem-loops and
    \subcaptionref{fig:mice:HDE-seqlogo}  Histone Downstream Elements (HDEs)
...
\newpage
\begin{center}
  \captionof{table}[Changes in mice histones since \citet{Marzluff02}]{
