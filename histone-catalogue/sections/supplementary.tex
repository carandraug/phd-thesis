  \begin{center}
    \captionof{table}[Changes in human histones since \citet{Marzluff02}]{%
  ...
  \newpage
  \captionof{table}[Human histone catalogue]{%
  ...
  \newpage
  \begin{center}
    \captionof{figure}[Human H2A CDS slignment]{
  ...
  \newpage
  \begin{center}
    \captionof{figure}[Human H2B CDS slignment]{
  ...
  \newpage
  \begin{center}
    \captionof{figure}[Human H3 CDS slignment]{
  ...
  \newpage
  \begin{center}
    \captionof{figure}[Human H4 CDS slignment]{
  ...
  \newpage
  \begin{center}
    \captionof{table}[Annotated histone variants]{
  ...
  \newpage
  \captionof{table}[Human histone variants catalogue]{%
  ...
  \newpage
  \begin{center}
    \captionof{table}[Anomalies in the annotation of human histones]{
    ...
    \begin{itemize}
    \input{\ResultsDir/histone_insanities.tex}
    \end{itemize}
  \end{center}
