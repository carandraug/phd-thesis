\section{Histone genes}
  ...
  \subsection{Canonical core histone gene nomenclature}
    ...
    \begin{figure*}
      \centering
      %% The total width of this figure is longer than the textwidth.
      %% That is because it was originally designed for a document
      %% with longer margins (and smaller fonts)
      ...
      \captionIntro{Histone gene nomenclature}{%
  ...
  \subsection{Histone gene sequences}
    ...
    human codons for most amino acids \trefp{tab:histone-gene-codonusage}.
