\section{Introduction}
  ...
  \afterpage{
  \begin{table}
    \captionIntro{Properties distinguishing canonical and variant core
                  histone proteins}%
                 {}
  ...
  \begin{table}
    \captionIntro{Count of human canonical core histone coding genes
                  and pseudogenes by histone cluster and type}%
                  {\textpsi{} indicates pseudogenes.}
  ...
  \subsection{Biochemical perspective}
    ...
    %% This is placed down here so it is placed at the top of a page.
    %% Because we also use afterpage for the other two tables before,
    %% this one would start at the middle of the page anyway.
    \afterpage{
    \captionofIntro{table}{Terminology describing histone variation}{}
