...
\label{ch:methods}
  ...
  \section{DNA methods}
    ...
    \subsection{Plasmid construction}
      ...
      protein was \gene{HIST1H2AE} but its sequence has a lower codon
  ...
  \section{Cell methods}
    ...
    \subsection{Generation of stable cell lines}
       Cells were trypsinized and split to a low confluence (1:20) on
       ...
       were observed so the highest expression cells were FACS sorted
       to obtain homogeneous populations \frefp{fig:methods:facs}.
